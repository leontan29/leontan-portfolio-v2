...
export default function Contact() {
  ...
  return (
    <section id="contact" ref={sectionRef} className="py-24 px-6 bg-gray-50">
      <div className="max-w-2xl mx-auto text-center">
        <h2
          className={`text-3xl md:text-4xl font-bold mb-6 text-center fade-in ${
            visible ? "visible" : ""
          }`}
        >
          Get in Touch
        ...
        <div
          className={`flex justify-center gap-8 fade-in ${
            visible ? "visible" : ""
          }`}
        >
          {/* LinkedIn */}
